...
function createCardElement(cardId, cardData) {
  ...
  const rankingButton = cardData.title === '游戏市场' ? 
    `<div class="ranking-button-container">
      <button class="ranking-button" onclick="window.open('https://databrain.woa.com/v2/intelligence/storeRanks/MobileGlobalRegion?filters_key=bded81aca6e4dc5829ad586fb0fa5371&', '_blank')">查看商店实时排名</button>
      <div class="ranking-hint">注：跳转后需注意自行选择国家</div>
    </div>` : '';
